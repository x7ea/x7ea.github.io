...
いわゆる身体的な強制（税務署の差し押さえや警察とか）は国家権力の例外状態に過ぎず、支配の本質は学生や社会人など主体＝在庫として現存在を挑発し駆り立てる**ゲシュテル**（集立）の働きであり、その枠組みに収まらない別の在り方を隠蔽する狭い開示様式を民衆の気遣いに了解させてるのが**スペクタクル**（見世物）の共同主観性なのだ。
